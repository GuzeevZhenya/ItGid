...
function t4(year, age) {
    return age - year;
}

document.querySelector('.b-4').onclick = function () {
    document.querySelector('.out-4').textContent = t4(1996, 2020);
}
...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Evgeny');
}
...
function t6(a, b) {
    let rand = a - 1 + Math.random() * (b - a + 1);
...
document.querySelector('.b-9').onclick = function () {
    document.querySelector('.out-9').textContent = t9(22);
}
...
document.querySelector('.b-10').onclick = function () {
    document.querySelector('.out-10').textContent = t10(3, 44);
}